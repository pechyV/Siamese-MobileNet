...
def evaluate():
    ...
    test_dataset = ChangeDetectionDataset(root_dir="./test_dataset/test/", transform=test_transform)
    test_loader = torch.utils.data.DataLoader(test_dataset, batch_size=1, shuffle=False, num_workers=0)

    # Inicializace confusion matrix
    ...
    with torch.no_grad():
        ...
        for t1, t2, labels in tbar:
            ...
            if cmat.shape == (2, 2):
                ...
                tn, fp, fn, tp = 0, 0, 0, 0  # Pokud jsou špatné hodnoty, nastavíme 0
